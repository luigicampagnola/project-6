...
import { IPathValue } from "./Interfaces/IPathValue";
...
export declare class Container {
    ...
    setNoise(noiseOrGenerator?: IMovePathGenerator | ((particle: Particle) => IPathValue), init?: () => void, update?: () => void): void;
    setPath(pathOrGenerator?: IMovePathGenerator | ((particle: Particle) => IPathValue), init?: () => void, update?: () => void): void;
    destroy(): void;
